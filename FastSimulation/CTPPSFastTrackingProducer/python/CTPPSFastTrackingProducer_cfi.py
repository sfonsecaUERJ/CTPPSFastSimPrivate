...
import SimTransport.HectorProducerForCTPPS.HectorTransport_cfi as TransportParameters

TPBeam1          = TransportParameters.LHCTransport.HectorForCTPPS.Beam1
TPBeam2          = TransportParameters.LHCTransport.HectorForCTPPS.Beam2
TPBeamEnergy     = TransportParameters.LHCTransport.HectorForCTPPS.BeamEnergy
TPCrossAngleCorr = TransportParameters.LHCTransport.HectorForCTPPS.CrossAngleCorr
TPCrossingAngle  = TransportParameters.LHCTransport.HectorForCTPPS.CrossingAngle
TPBeamLineLengthCTPPS = TransportParameters.LHCTransport.HectorForCTPPS.BeamLineLengthCTPPS
